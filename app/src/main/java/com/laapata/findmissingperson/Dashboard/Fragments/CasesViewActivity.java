...
public class CasesViewActivity extends AppCompatActivity {
...
*/
    ...
    private void searchUsers(final String s) {
        Query query = FirebaseDatabase.getInstance().getReference("FoundedPersonsCases").orderByChild("mpname")
                .startAt(s)
                .endAt(s+"\uf8ff");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                userAdapter = new RecyclerAdapter_Fp_Reports(CasesViewActivity.this, mUsers);
...
//        super.onStart();
        // data is found
        final ProgressDialog dialog = new ProgressDialog(CasesViewActivity.this);
       ...
       ref2 = FirebaseDatabase.getInstance().getReference("FoundedPersonsCases");
