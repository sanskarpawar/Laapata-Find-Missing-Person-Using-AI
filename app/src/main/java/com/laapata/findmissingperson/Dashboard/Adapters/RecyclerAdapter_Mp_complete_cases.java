...
public class RecyclerAdapter_Mp_complete_cases extends RecyclerView.Adapter<RecyclerAdapter_Mp_complete_cases.ViewHolder> {

    private Context mContext ;
    private List<FoundPersonModel> mUsers ;
    private FirebaseAuth auth ;
    public RecyclerAdapter_Mp_complete_cases(Context mContext, List<FoundPersonModel> mUsers) {
    ...
    @NonNull
    @Override
    public RecyclerAdapter_Mp_complete_cases.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate( R.layout.recycler_row_gigs, parent, false);
        auth = FirebaseAuth.getInstance();
        return new RecyclerAdapter_Mp_complete_cases.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecyclerAdapter_Mp_complete_cases.ViewHolder holder, int position) {
